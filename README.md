...
<p align="center">
    ...
    <h3 align="center"><a href="https://learnwithsumit.com/courses/think-in-a-redux-way/cache-behavior">THINK IN A REDUX WAY - MODULE 8 - LESSON 9 </a></h3>
</p>
...
3. Go to the cloned project directory
   ...
   ```
4. Checkout/switch to branch 8.9
   ```sh
   git checkout 8.9
   ```
