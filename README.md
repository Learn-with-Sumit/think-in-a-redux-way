...
<p align="center">
    ...
    <h3 align="center"><a href="https://learnwithsumit.com/courses/think-in-a-redux-way/tags-feature-2">THINK IN A REDUX WAY - MODULE 6 - LESSON 8 </a></h3>
</p>
...
3. Go to the cloned project directory
   ...
   ```
4. Checkout/switch to branch 6.8
   ```sh
   git checkout 6.8
   ```
