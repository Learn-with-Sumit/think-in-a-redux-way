...
<p align="center">
    ...
    <h3 align="center"><a href="https://learnwithsumit.com/courses/think-in-a-redux-way/tags-feature-1">THINK IN A REDUX WAY - MODULE 6 - LESSON 7 </a></h3>
</p>
...
3. Go to the cloned project directory
   ...
   ```
4. Checkout/switch to branch 6.7
   ```sh
   git checkout 6.7
   ```
