...
<p align="center">
    ...
    <h3 align="center"><a href="https://learnwithsumit.com/courses/think-in-a-redux-way/react-ui">THINK IN A REDUX WAY - MODULE 7 - LESSON 2 </a></h3>
</p>
...
3. Go to the cloned project directory
   ...
   ```
4. Checkout/switch to branch 7.2
   ```sh
   git checkout 7.2
   ```
