...
<p align="center">
    ...
    <h3 align="center"><a href="https://learnwithsumit.com/courses/think-in-a-redux-way/redux-hooks-usedispatch">THINK IN A REDUX WAY - MODULE 2 - LESSON 6</a></h3>
</p>
...
3. Go to the cloned project directory
   ...
   ```
4. Checkout/switch to branch 2.6
   ```sh
   git checkout 2.6
   ```
