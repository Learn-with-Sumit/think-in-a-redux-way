...
<p align="center">
    ...
    <h3 align="center"><a href="https://learnwithsumit.com/courses/think-in-a-redux-way/create-apis">THINK IN A REDUX WAY - MODULE 7 - LESSON 3 </a></h3>
</p>
...
3. Go to the cloned project directory
   ...
   ```
4. Checkout/switch to branch 7.3
   ```sh
   git checkout 7.3
   ```
