...
<p align="center">
    ...
    <h3 align="center"><a href="https://learnwithsumit.com/courses/think-in-a-redux-way/redux-combinereducers">THINK IN A REDUX WAY - MODULE 2 - LESSON 7</a></h3>
</p>
...
3. Go to the cloned project directory
   ...
   ```
4. Checkout/switch to branch 2.7
   ```sh
   git checkout 2.7
   ```
