...
<p align="center">
    ...
    <h3 align="center"><a href="https://learnwithsumit.com/courses/think-in-a-redux-way/adding-video">THINK IN A REDUX WAY - MODULE 8 - LESSON 8 </a></h3>
</p>
...
3. Go to the cloned project directory
   ...
   ```
4. Checkout/switch to branch 8.8
   ```sh
   git checkout 8.8
   ```
